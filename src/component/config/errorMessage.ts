export const errorMessage = (type: "token" | "year" | "value" | "strategy" | "triggerStrategy") => {
    ...
    switch (type) {
        ...
        case "triggerStrategy":
            response = "A good strategy should have at least 2 stoplosses. The first stoploss is set at your entry with target percent = 0 and the last stoploss is set when you want to take profit. Example: If you want target hit 3% then take profit, you should set target = 3 and percent = 3";
            break;
        default:
